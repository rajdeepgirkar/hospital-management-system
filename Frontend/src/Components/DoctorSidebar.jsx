...
function DoctorSidebar({ currentTab, setCurrentTab, profile }) {
  ...
  const menuItems = [
    ...
    { id: "appointments", label: "Manage Appointments", icon: <CalendarMonthIcon /> },
    ...
    >
      ...
      <Box sx={{ p: 3, display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center" }}>
        ...
        <Typography variant="subtitle1" sx={{ fontWeight: 600, color: "#f8fafc", fontFamily: "Poppins" }}>
          {profile ? `Dr. ${profile.firstName} ${profile.lastName}` : "Doctor"}
        </Typography>
